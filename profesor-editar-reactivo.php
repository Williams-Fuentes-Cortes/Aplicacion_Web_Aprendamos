...
<head>
    ...
    <title>Profesor - Editar - Reactivo</title>
...
<body>
	...
	<nav class="navbar navbar-expand topbar mb-2 static-top shadow">
		  <div class="collapse text-gray-900 navbar-collapse" id="navbarNavDropdown">
			  ...
			  <h5><i class="fas fa-book fa-sm"></i> Repositorio <i class="fas ml-2 mr-2 fa-arrow-right  fa-sm"></i> Reactivo Materia <i class="fas ml-2 mr-2 fa-arrow-right  fa-sm"></i> Editar Reactivo</h5>
			  </div>
	</nav>
	<!-- End of Topbar -->      
        ...
        <div class="row pl-md-3 pr-md-3">
                ...
                <div class="card shadow border-left-success">
                    ...
                    <div class="card-body">
                            ...
                            <div class="text-right">
                                ...
                                <a href="#edit" class="btn btn-success " data-toggle="modal"> Editar Reactivo</a>
            ...
            <div class="col-xl-3 col-xs-0">
                <div class="card shadow border-left-info">
                    <div class="card-header"><i class="fas ml-2 mr-2 fa-info-circle fa-sm"></i>Información</div>
                    <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <!-- Contenido de la ventana -->
                    <div class="modal-body" >
                        <div class="text-body text-gray-900"><p>¿Está seguro de editar este reactivo?</p></div>
                    </div> 
    ...
    <div class="modal fade" id="cancel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <!-- Contenido de la ventana -->
                    <div class="modal-body" >
                        <div class="text-body text-gray-900">¿Está seguro de cancelar la edición de este reactivo?<br>No se guardarán los cammbios realizados.</div>
                    </div> 
                <!-- Foooter de la ventana -->
                <div class="modal-footer">
					<button tyle="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
