...
<head>
    ...
    <title>Profesor - Crear - Cuestionario</title>
...
<body>
	...
	<nav class="navbar navbar-expand topbar mb-2 static-top shadow">
		  <div class="collapse text-gray-900 navbar-collapse" id="navbarNavDropdown">
			  ...
			  <h5><i class="fas fa-align-justify fa-sm"></i> Cuestionarios <i class="fas ml-2 mr-2 fa-arrow-right  fa-sm"></i> Crear Cuestionario</h5>
			  </div>
	</nav>
	<!-- End of Topbar -->      
                    ...
                    <div class="card m-3">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="col m-3">
                                        <div class="card">
                                          <ul class="list-group ">
                                            ...
                                            <div class="row">
                                                <div class="col pl-4">    
                                                <input type="checkbox" class="form-check-input" id="vist1">
                                                <label class="form-check-label" for="vist1">Enunciado del reactivo ...</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col pl-4">    
                                                <input type="checkbox" class="form-check-input" id="vist2">
                                                <label class="form-check-label" for="vist2">Enunciado del reactivo ...</label>
                                                </div>
                                            </div>
                                            <div class="row pl-4">a)Respuesta1 b)Respuesta2 <br>a)Respuesta3 b)Respuesta4</div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col pl-4">    
												<input type="checkbox" class="form-check-input" id="vist3">
                                                <label class="form-check-label" for="vist3">Enunciado del reactivo ...</label>
                                                </div>
                                            </div>
                                            <div class="row pl-4">a)Respuesta1 b)Respuesta2 <br>a)Respuesta3 b)Respuesta4</div>
                                            <div class="row">
                                    ...
                                    <div class="card shadow">
                                        ...
                                        <div class="row">
                                            <div class="col m-2 text-right">
                                                <button tyle="button" class="btn btn-secondary">Agregar al cuestionario</button>
                                            </div>
                                        </div>
                            ...
                            <div class="row m-2">
                                ...
                                <a href="#guar" class="btn btn-success " data-toggle="modal"> Crear Cuestionario</a>
                                </div>
                            </div>                        
    ...
    <div class="modal fade" id="guar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="guar1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <!-- Contenido de la ventana -->
                    ...
                    <div class="modal-body" >
                        <div class="text-body text-gray-900">¿Está seguro de cancelar la creación de este cuestionario?<br>No se guardará el trabajo realizado</div>
                    </div>   
                <!-- Foooter de la ventana -->
                <div class="modal-footer">
					<button tyle="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
