             ...
             <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="m-5 text-gray-900">
                        ...
                        <div class="card">
                       <div class="pregresp">
                          <div class="h5 mb-0 pregunta mb-4">1.- Enunciado del reactivo<br /></div>
                    ...
                    <div class="text-left mt-2">      
                     ...
                     <a href="#verificarP" class="btn btn-success ml-2"> Verificar </a>    
                    </div>
                </div>
            </div>
           ...
           <div class="col offset-md-3">
            <nav aria-label="Page navigation">
              <ul class="pagination ">
                ...
                <li class="page-item"><a class="page-link" href="alumno_cuestionario2.php">10</a></li>
                <li class="page-item">
