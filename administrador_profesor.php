            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand topbar mb-2 static-top shadow">
                    ...
                    <div class="collapse text-gray-900 navbar-collapse" id="navbarNavDropdown">
                        <h5><i class="fas fa-users  fa-sm"></i> Cuentas <i class="fas ml-2 mr-2 fa-arrow-right  fa-sm"></i> Profesores</h5>
                    </div>
                                ...
                                <div class="card border-left-success m-3">
                                        ...
                                        <div class="d-sm-flex align-items-center justify-content-between mb-2 m-2 form-group">
                                            ...
                                            <div class="form-label-group">
                                                <select class="form-control" name="menu" size="1">
                                                    <option value="0">Grado máximo de estudios</option>
                                                    <option value="0">Ingeniería/Licenciatura</option>
                                                    <option value="0">Maestría</option>
                                                    <option value="0">Doctorado</option>
                                                </select>
                                            </div>
                                            <div>
                                                <input type="checkbox" id="select11">
                                                <label for="select11" class="ml-1">Seleccionar todo</label>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <p style="font-size: 16px;">
                                            <input type="checkbox"> CVU Ediwr Acevedo Acevedo</p>
                                        <p style="font-size: 16px;">
                                            <input type="checkbox"> CVU Marco Antonio Acevedo Escudero</p>
                                        <p style="font-size: 16px;">
                                            <input type="checkbox"> CVU Carlos Eugenio Cabrera Guerra</p>
                                        <p style="font-size: 16px;">
                                            <input type="checkbox"> CVU Williams Fuentes Cortes</p>
                                    </div>
                                ...
                                <div class="card border-left-success m-3">
                                    <div class="card-header">
                                        ...
                                        <div class="d-sm-flex align-items-center justify-content-between mb-2 m-2 form-group">
                                            ...
                                            <div>
                                                <input type="checkbox" id="select21">
                                                <label for="select21" class="ml-1">Seleccionar todo</label>
                                            </div>
                                            <li class="sidebar-search" style="list-style:none;">
                                                <div class="input-group ">
                                                    <input type="text" class="form-control bg-ight border-dark small text-rigthd" placeholder="Buscar" arial-label="Buscar" aria-describedby="basic-addon2">
