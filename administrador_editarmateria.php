...
<head>
    ...
    <title>Administrador - Editar materia</title>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand topbar mb-2 static-top shadow">
                    ...
                    <div class="collapse text-gray-900 navbar-collapse" id="navbarNavDropdown">
                        <h5><i class="fas fa-book  fa-sm"></i> Materias <i class="fas ml-2 mr-2 fa-arrow-right  fa-sm"></i> Editar materia</h5>
                    </div>
                    ...
                    <div class="modal fade" id="error">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-gray-900">
                                    <div class="text-left">
                                        <h6>Hubo un error al actualizar la materia.</h6></div>
                                </div>
                                <!-- Foooter de la ventana -->
                                <div class="modal-footer">
